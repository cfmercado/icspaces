...
const SchedulesPage_Admin = () => {
  ...
  useEffect(() => {
    const fetchRevenue = async () => {
      ...
      let url = "https://api.icspaces.online/get-revenue-by-room-and-status";
      let options = {
        method: "POST",
        headers: {
      ...
      if (selectedRoom === -1) {
        url = "https://api.icspaces.online/get-revenue-by-room-and-status";
        options = {
          ...options,
          body: JSON.stringify({
            room_id: selectedRoom,
  ...
  useEffect(() => {
    const fetchReservations = async () => {
      ...
      let url = "https://api.icspaces.online/get-all-reservations-by-room-and-status";
      let options = {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
      ...
      if (selectedRoom === null) {
        url = "https://api.icspaces.online/get-all-reservations-by-room-and-status";
        options = {
          ...options,
          body: JSON.stringify({
            status_code: 2,
