      ...
      <DialogContent sx={{ overflow: 'hidden'}}>
        {reservation && (
          <>
            ...
            {actionTaken === "approve" && (
              <ReservationDialogPopupApproved open={bookedDialogOpen} onClose={() => setBookedDialogOpen(false)} reservation={reservation} />
            )}

            {actionTaken === "disapprove" && (
              <ReservationDialogPopupDisapproved open={disapprovedDialogOpen} onClose={() => setDisapprovedDialogOpen(false)} reservation={reservation} />
            )}
          </>
        )}
      </DialogContent>      
