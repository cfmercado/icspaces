...
const GuestFAQ_Accordion: React.FC = () => {
  return (
      ...
      <Grid item>
        <Accordion>
          <AccordionSummary
            ...
            id="panel1a-header"
          >
            <Typography fontWeight="bold">Guest FAQ 1</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <Typography>
              {" "}
      ...
      <Grid item>
        <Accordion>
          <AccordionSummary
            ...
            id="panel2a-header"
          >
            <Typography fontWeight="bold">Guest FAQ 2</Typography>
          </AccordionSummary>
          <AccordionDetails>
...
export default GuestFAQ_Accordion;
