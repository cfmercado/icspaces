...
const FacultyFAQ_Accordion: React.FC = () => {
  return (
      ...
      <Grid item>
        <Accordion>
          <AccordionSummary
            ...
            id="panel1a-header"
          >
            <Typography fontWeight="bold">FACULTY FAQ 1</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <Typography>
              {" "}
      ...
      <Grid item>
        <Accordion>
          <AccordionSummary
            ...
            id="panel2a-header"
          >
            <Typography fontWeight="bold">FACULTY FAQ 2</Typography>
          </AccordionSummary>
          <AccordionDetails>
...
export default FacultyFAQ_Accordion;
